...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/a_Xa'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_Bn chc chn mun xa ngi hc ny khi lp hcHyXc nhn'))

WebUI.getText(findTestObject('Page_Hc liu - Sch Mm/div_Bn chc chn mun xa ngi hc ny khi lp hcHyXc nhn'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/button_Hy'))

WebUI.verifyElementNotPresent(findTestObject('Page_Hc liu - Sch Mm/div_Bn chc chn mun xa ngi hc ny khi lp hcHyXc nhn'), 
    0)
