...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/code_atfovxw'))
...
WebUI.verifyElementPresent(findTestObject('Page_Hc liu - Sch Mm/div_Li  Bn khng th tham gia lp hc do mnh ging dy'), 0)

WebUI.getText(findTestObject('Page_Hc liu - Sch Mm/div_Li  Bn khng th tham gia lp hc do mnh ging dy'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_Li  Bn khng th tham gia lp hc do mnh ging dy'))
