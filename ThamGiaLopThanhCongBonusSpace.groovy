...
WebUI.verifyElementPresent(findTestObject('Page_Hc liu - Sch Mm/div_Thnh cng  Tham gia lp thnh cng'), 0)

WebUI.getText(findTestObject('Page_Hc liu - Sch Mm/div_Thnh cng  Tham gia lp thnh cng'))

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/div_Thnh cng  Tham gia lp thnh cng'))
